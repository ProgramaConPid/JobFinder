/* ./js/language.js - Improved and simplified version */
(function () {
  "use strict";

  // Complete translations (do not modify the content of this object)
  const translations = {
    en: {
      "header.title": "Welcome to JobFinder",
      "header.subtitle":
        "We connect talent with opportunities. Choose your profile to get started.",
      "applicant.title": "I am an Applicant",
      "applicant.description":
        "I'm looking for job opportunities and want to connect with companies",
      ...
      "contact.aboutUsDesc":
        "This project is your all-in-one launchpad to job opportunities, recruiter connections, and skill-building — giving every job seeker the tools to rise, thrive, and lead their future.",
      "contact.chatRecruiters": "Chat with Recruiters",
      "contact.chatRecruitersDesc":
      ...
      "footer.copyright":
        "© 2025 JobFinder. All rights reserved — We don't just help you find work, we help you find purpose.",
      ...
      "dashboardCompany.subtitle":
        "Manage your job offers and review applicants",
      ...
      "dashboardCompany.completeProfileText":
        "Complete your company profile to increase visibility",
      "dashboardCompany.complete": "Complete",
      "dashboardCompany.reviewApplicationsText":
        "Review the 5 new pending applications",
      ...
      "dashboardCompany.descriptionPlaceholder":
        "Write a short description about the role, responsibilities and requirements",
      ...
      "profileCompany.descriptionPlaceholder":
      ...
      "dashboardCoder.subtitle":
        "Explore job offers and manage your applications",
    ...
    es: {
      ...
      "header.subtitle":
        "Conectamos talento con oportunidades. Elige tu perfil para comenzar.",
      ...
      "company.description":
        "Publico ofertas de empleo y busco el mejor talento",
      "company.button": "Continuar como Empresa",
      "contact.title": "Herramientas JobFinder",
      "contact.searchJobs": "Buscar Empleos",
      "contact.searchJobsDesc":
        "Encuentra vacantes que coincidan con tu perfil",
      "contact.aboutUs": "Sobre Nosotros",
      "contact.aboutUsDesc":
        "Este proyecto es tu plataforma integral hacia oportunidades laborales, conexiones con reclutadores y desarrollo de habilidades — dándole a cada buscador de empleo las herramientas para crecer, destacar y liderar su futuro.",
      "contact.chatRecruiters": "Chatea con Reclutadores",
      "contact.chatRecruitersDesc":
        "Inicia conversaciones con posibles empleadores",
      ...
      "footer.copyright":
        "© 2025 JobFinder. Todos los derechos reservados — No solo te ayudamos a encontrar trabajo, te ayudamos a encontrar propósito.",
      ...
      "dashboardCompany.subtitle":
        "Gestiona tus ofertas de trabajo y revisa solicitantes",
      ...
      "dashboardCompany.completeProfileText":
        "Completa tu perfil de empresa para aumentar la visibilidad",
      "dashboardCompany.complete": "Completar",
      "dashboardCompany.reviewApplicationsText":
        "Revisa las 5 nuevas solicitudes pendientes",
      ...
      "dashboardCompany.jobTitlePlaceholder":
        "ej. Desarrollador Backend Node.js",
      ...
      "dashboardCompany.descriptionPlaceholder":
        "Escribe una breve descripción sobre el rol, responsabilidades y requisitos",
      ...
      "profileCompany.subtitle":
        "Gestiona la información de tu empresa y ofertas de trabajo",
      ...
      "profileCompany.descriptionPlaceholder":
        "Describe la cultura, misión y valores de tu empresa...",
      ...
      "dashboardCoder.subtitle":
        "Explora ofertas de trabajo y gestiona tus solicitudes",
  ...
  // Apply translations to all elements with data-i18n, data-i18n-placeholder, or data-i18n-attr
  ...
  // Update the language toggle button and flag icon
  ...
  function initLanguage() {
    ...
    // Set up event for language toggle button
